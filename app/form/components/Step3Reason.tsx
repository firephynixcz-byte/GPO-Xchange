...
const Step3Reason = ({ next, back, updateData }: StepProps) => {
  return (
    <div className="p-6 bg-white rounded-2xl border border-slate-100 shadow-sm">
      <h2 className="text-lg font-bold mb-4">Step 3: เหตุผลการส่งคืน</h2>
      {/* ใส่เนื้อหา Step 3 ของกิตที่นี่ */}
